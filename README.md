...
| Skill | What It Does | Use When |
|-------|-------------|----------|
| [chaos-engineering](skills/chaos-engineering/SKILL.md) | Systematic fault injection and resilience testing | Designing for high availability, verifying disaster recovery |
| [cost-optimization](skills/cost-optimization/SKILL.md) | Cloud spend reduction without sacrificing reliability | Bills growing unpredictably, rightsizing resources |
| [data-engineering](skills/data-engineering/SKILL.md) | Data pipelines, ETL/ELT, schema evolution, data quality | Building data pipelines, migrating schemas |
| [ai-ops](skills/ai-ops/SKILL.md) | ML model deployment, monitoring, drift detection, retraining | Deploying models, managing inference infrastructure |
...
| [site-reliability-engineer](agents/site-reliability-engineer.md) | Site Reliability Engineer | Availability, observability, capacity planning, and incident readiness audits |
...
| [reliability-checklist.md](references/reliability-checklist.md) | Availability, observability, capacity, incident response, data integrity |
...
See [docs/skill-anatomy.md](docs/skill-anatomy.md) for the format specification and [CONTRIBUTING.md](CONTRIBUTING.md) for guidelines. Every PR goes through the same quality gates the skills enforce — eat your own dog food.
