# Using SkillEngine with GitHub Copilot

## Setup

### Copilot Instructions

Copilot supports creating SkillEngine skills using a `.github/skills`, `.claude/skills`, or `.agents/skills` directory in your repository.

```bash
mkdir -p .github

# Create files for essential skills
cat /path/to/SkillEngine/skills/test-driven-development/SKILL.md > .github/skills/test-driven-development/SKILL.md
cat /path/to/SkillEngine/skills/code-review-and-quality/SKILL.md > .github/skills/code-review-and-quality/SKILL.md
```
...
Copilot supports specialized agent personas. Use the SkillEngine agents:
...
cp /path/to/SkillEngine/agents/code-reviewer.md .github/agents/code-reviewer.agent.md
cp /path/to/SkillEngine/agents/test-engineer.md .github/agents/test-engineer.agent.md
cp /path/to/SkillEngine/agents/security-auditor.md .github/agents/security-auditor.agent.md
```
