# Using SkillEngine with Windsurf
...
cat /path/to/SkillEngine/skills/test-driven-development/SKILL.md > .windsurfrules
echo "\n---\n" >> .windsurfrules
cat /path/to/SkillEngine/skills/incremental-implementation/SKILL.md >> .windsurfrules
echo "\n---\n" >> .windsurfrules
cat /path/to/SkillEngine/skills/code-review-and-quality/SKILL.md >> .windsurfrules
```
