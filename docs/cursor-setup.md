...
cp /path/to/SkillEngine/skills/test-driven-development/SKILL.md .cursor/rules/test-driven-development.md
cp /path/to/SkillEngine/skills/code-review-and-quality/SKILL.md .cursor/rules/code-review-and-quality.md
cp /path/to/SkillEngine/skills/incremental-implementation/SKILL.md .cursor/rules/incremental-implementation.md
```
...
cat /path/to/SkillEngine/skills/test-driven-development/SKILL.md > .cursorrules
echo "\n---\n" >> .cursorrules
cat /path/to/SkillEngine/skills/code-review-and-quality/SKILL.md >> .cursorrules
```
