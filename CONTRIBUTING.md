...
# Run cross-skill consistency checks
...
- **Skill anatomy:** YAML frontmatter, required sections, description quality
- **Cross-skill consistency:** No dead references, valid internal links
- **Agent persona validation:** References to known skills, required sections
- **Lifecycle coverage:** Every phase has skills mapped
- **Hook integrity:** Session start and simplify-ignore hooks pass tests
...
- Run `node scripts/quality-gate.js` to check cross-skill consistency
