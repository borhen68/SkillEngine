...
**Real-world impact:** The cost of a failed launch with no rollback is 10-100x the cost of spending an extra hour on preparation. The worst time to write a rollback plan is when the alert is firing.
